...
const COPY: Record<AppLanguage, Copy> = {
  hu: {
    ...
    primaryCta: 'MemoryBook készítése',
    ...
    bottomCta: 'Emlékkönyvet készítek',
  },
  en: {
    login: 'Sign in',
    eyebrow: 'MemoryBook',
    ...
    primaryCta: 'Create a MemoryBook',
    ...
    bottomCta: 'Create my memory book',
  },
  de: {
    login: 'Anmelden',
    eyebrow: 'MemoryBook',
    ...
    primaryCta: 'MemoryBook erstellen',
    ...
    bottomCta: 'Erinnerungsbuch erstellen',
  },
};
