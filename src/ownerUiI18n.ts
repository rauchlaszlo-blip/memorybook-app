...
const translations: Record<string, Translation> = {
  ...
  'Galéria': { en: 'Gallery', de: 'Galerie' },
  'A fénykép bevitelét a következő lépésben kapcsoljuk be.': { en: 'Photo input will be enabled in the next step.', de: 'Die Fotoauswahl wird im nächsten Schritt aktiviert.' },
  ...
  'Fekete': { en: 'Black', de: 'Schwarz' },
  'Fehér': { en: 'White', de: 'Weiß' },
  'Piros': { en: 'Red', de: 'Rot' },
  'Kék': { en: 'Blue', de: 'Blau' },
  ...
  'Saját emlék': { en: 'My own memory', de: 'Eigene Erinnerung' },
  'Készíts saját emlékoldalt szöveggel, rajzzal és képpel.': { en: 'Create your own memory page with text, drawings and images.', de: 'Erstelle deine eigene Erinnerungsseite mit Text, Zeichnungen und Bildern.' },
  'Saját emlék létrehozása': { en: 'Create my memory', de: 'Eigene Erinnerung erstellen' },
  'A saját emléklapot nem sikerült megnyitni.': { en: 'Could not open your memory page.', de: 'Die eigene Erinnerungsseite konnte nicht geöffnet werden.' },
  ...
  'Vendégkönyv elérhetősége': { en: 'Guestbook availability', de: 'Verfügbarkeit des Gästebuchs' },
  'A vendégkönyv nyitva van': { en: 'The guestbook is open', de: 'Das Gästebuch ist geöffnet' },
  'Automatikus lezárás (opcionális)': { en: 'Automatic closing (optional)', de: 'Automatisches Schließen (optional)' },
  'Kezdés időpontja (opcionális)': { en: 'Start time (optional)', de: 'Startzeit (optional)' },
  'Befejezés időpontja (opcionális)': { en: 'End time (optional)', de: 'Endzeit (optional)' },
  'A vendégkönyv csak a megadott kezdési és befejezési időpont között használható.': { en: 'The guestbook can only be used between the selected start and end times.', de: 'Das Gästebuch kann nur zwischen der festgelegten Start- und Endzeit verwendet werden.' },
  'Ha nem adsz meg időpontot, a vendégkönyv addig marad nyitva, amíg kézzel le nem zárod.': { en: 'Without a closing time, the guestbook stays open until you close it manually.', de: 'Ohne Schließzeit bleibt das Gästebuch geöffnet, bis du es manuell schließt.' },
  ...
  'Családi vagy nagy közösségi eseményen egy közös QR-kódot tehetsz ki. Minden vendég ugyanabba a vendégkönyvbe írhat.': { en: 'At a family or large community event, you can display one shared QR code. Every guest can write in the same guestbook.', de: 'Bei einer Familienfeier oder großen Gemeinschaftsveranstaltung kannst du einen gemeinsamen QR-Code aufstellen. Alle Gäste schreiben in dasselbe Gästebuch.' },
