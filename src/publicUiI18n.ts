...
const translations: Record<string, Translation> = {
  ...
  'Add meg a szervező által kért adatokat, majd nyisd meg a rajzlapot.': { en: 'Enter the information requested by the organizer, then open the canvas.', de: 'Gib die vom Veranstalter angeforderten Daten ein und öffne anschließend die Zeichenfläche.' },
  'Rajzlap megnyitása': { en: 'Open canvas', de: 'Zeichenfläche öffnen' },
  'Rajzlap megnyitása...': { en: 'Opening canvas...', de: 'Zeichenfläche wird geöffnet...' },
  'Adj meg érvényes e-mail-címet.': { en: 'Enter a valid email address.', de: 'Gib eine gültige E-Mail-Adresse ein.' },
  'A rajzlapot nem sikerült megnyitni. Próbáld újra.': { en: 'The canvas could not be opened. Try again.', de: 'Die Zeichenfläche konnte nicht geöffnet werden. Versuche es erneut.' },
